...
Parsing is the process of analysing a JSON string and creating an object that can be manipulated and accessed through your programming language; in this case, JavaScript. When you receive JSON strings like this from an API, they need to be parsed so they can be a useable 
