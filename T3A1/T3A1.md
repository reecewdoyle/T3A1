...
* **Scalability:** This is can be the make-or-break point for a piece of software. The performance must justify the expense of integrating it into the system or it won't be viable. 
  e.g. Cheaper and worse performing software can still be selected over the more expensive software when the financial outlay doesn't stack up. 
...
Croft, Andi, 6 Essential Metrics for Software Quality, 2022,
https://huddle.eurostarsoftwaretesting.com/6-essential-metrics-for-software-quality/

Jayalakshmi Iyer, Sanika, What is Software Quality Assurance, and why is it important?, 2023,
https://www.turing.com/blog/software-quality-assurance-and-its-importance/#:~:text=The%20three%20primary%20aspects%20of,reliability%2C%20portability%2C%20and%20efficiency.
...
To create a quality piece of application (as per the 6 principles of quality software mentioned above), it makes sense to split the Frontend and Backend into directories. 
#### Backend Directory
...
Each section of the code is broken up into files and folders so it's easy to find and maintain:
 ...
 * **routes:** This is the point where the routing for everything around the application is detailed.  This determines how each file is connected to each-other. 
...
This is an example of a Frontend file directory that would be built using React, and would work with the above backend directory.
...
* **src:** This contains the source code for the frontend application. The src folder must contain the following:
	...
	* **components:** This is where the React components are found. They are what builds the UI. 
	  
	* **app.js:** This is the file where the frontend application renders components of the web app.
	  
	* **index.js:** This is the entry point to the front end of the app. 
