...
***
An array is variable that acts a bit like a container to store data of various types that an later be assess with another variable. You can have multiple datatypes stored at 
