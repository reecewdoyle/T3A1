...
"this.present()" calls the result of what we got on the for "present()" at the end of the Car class. `+` concatinates the result of "this.present" with `, it was made in `. `+` again to concatinate with "this.model"
*/
	} 
} 
