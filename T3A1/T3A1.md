...
A Release branch will be created to prepare the product for release. This is where the final level of testing, last minute fixes, and Version Tagging can happen. Once all of this has cleared, the Release
