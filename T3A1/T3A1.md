...
While the Front End makes the Web App usable and aesthetically pleasing, the Back End is the "plumbing" that actually makes the Web App work. This is the part that makes the User Experience possible. You will need some proficiency in:
...
2. Databases: This could be PostgreSQL, MySQL, Oracle, MongoDB or some other kind of Relational Database. 
