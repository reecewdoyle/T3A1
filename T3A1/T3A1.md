...
#### Model 
This is the component of the app that is responsible for managing the storage and retrieval of data. In a MERN stack, the database used for this is MongoDB. 
