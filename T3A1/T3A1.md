...
**Feature Branches:** This is where individual features can be worked on. They're independent from the other branches, and will generally be one per feature. Once a feature is stable enough on it's own, it can be merged into the development branch w
