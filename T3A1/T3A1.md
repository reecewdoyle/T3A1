...
![ERD B](erdB.png)
I decided that I needed this table as my first design was only going to allow me to assign a single musician to each `Gig` entry, which was not fit for purpose, as all each entry was going to have at least 2 musicians at it. My solution was to add a `Band` table. This was to account for the nature of the work. I
***
### References
