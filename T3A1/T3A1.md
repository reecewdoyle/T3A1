...
`i + 1980` means that x will be declared as 1980 + the value at the current index. Therefore, the value at index 0 will be 1980 + 0 = 1980. The value at index 1 will be 1981, index 2 will be 1982 etc, all the way up to index 39 which will be 
*/
```
