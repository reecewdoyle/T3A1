...
React is what is the library used to build the User Interface. It communicates with the Node API using HTTP requests in the JSON format to the Node API
