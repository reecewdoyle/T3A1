...
I think if I were doing this project again, apart from spending tI would do either just the `Musicians` or just the `Setlists` components on their own. Each of these problems would have met the scope of the requirements of the assignment. 
