...
React is what is the library used to build the User Interface. The app communicates with the Node API using HTTP requests in the JSON format. The API accesses MongoDB's database to return the queries that the 
