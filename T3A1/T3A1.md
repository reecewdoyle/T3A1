...
Parsing is the process of analysing a JSON  string and creating an object that can be manipulated and accessed through your programming language; in this case it's JavaScript.
