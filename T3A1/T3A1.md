...
If you use the strict equality operator `===`, you won't get any type coercion. However, if you use the loose equality operator `==`, you will get type coercion, depending on the contex
