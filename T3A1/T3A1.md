...
`BigInt` is used to represent whole numbers that are larger than 2^53 -1. this is the highest number that JavaScript can reliable represent within the `Number` data type. Expressed as an integer, the value is `9007199254740991`
```javascript
