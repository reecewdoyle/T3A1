...
At some point I also attempted to get around the join table for the `songs` and `setlist` table by creating 3 different tables. The problem I found here was that a `First Dance` song could be a `Cocktail Hour`
