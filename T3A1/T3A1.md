...
**Main Branch:** The (main or Master) branch will be the stable branch that contains the production-ready codebase. This is when the project has been developed to the point of a minimum viable product and it's 
