...
```javascript
const person = { 
	firstname: "Bruce", surname: "Wayne", age: 41, city: "Gotham City", occupation: "Batman", height: 185, // Method to greet the person greet: function() { console.log(`Hello, I'm ${this.firstname} ${this.surname}!`); } };
```
