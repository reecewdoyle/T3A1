...
1.  HTML/CSS: T(Hyper Text Markup Language & Cascading Style Sheets) These are the languages that determine what the structure of the website is going to look like. 
