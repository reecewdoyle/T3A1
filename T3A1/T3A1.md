...
5. Design skills: While a Web Dev might not be expected to be the person to design a website, it's inevitable that some design may come up along the way. This could be a feature that the client has missed, or possibly that something that isn't working. It would be beneficial for a Web Dev to have some 
