...
![ERD B](erdB.png)
I decided that I needed this table as my first design was only going to allow me to assign a single musician to each `Gig` entry, which was not going to work, as 
***
### References
