...
An `Object` in JavaScript is the way that we store data. They come in the form of key-value pairs and are instantiated using curly braces {}. The use for objects is limited only by your imagination. Let's say you wanted to store a biography of the singer Seal that could be ac
