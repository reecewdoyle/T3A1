...
* **Modularity:** A modular piece of software would be made of seperate parts that can be independently modified, fixed and upgraded. e.g. if a codebase is written in a single large file, it will be very difficult to find 
