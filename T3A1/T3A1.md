...
Loops are pieces of code that iterate until there is nothing left to loop, or a condition is met. This means you have to be careful to not write code that is 
