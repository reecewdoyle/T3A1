...
This code snippet outputs sentences of text stating that it has a car of a particular brand and it's model. 

Am example of the output might be:
"I have a Ford, it was made in 1995"

The brand is limited to the answers 
