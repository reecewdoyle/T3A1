...
Learning to use `colored` allowed me to change the colours of the text in my app. This was especially helpful with readability. It also allowed me to make the team names reflect the team colours in the `print_teams, `
