...
* **Availability:** The software needs to be accessible on the optimal platform when needed. e.g. A Map and Directions software that wasn't available on a mobile device would 
