...
* **Fault Tolerance:**  The software handles errors gracefully and continues to work when it receives incorrect input. e.g. Does a streaming service have a system in place 
