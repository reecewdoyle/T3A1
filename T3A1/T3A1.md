...
A Release branch will be created to prepare the product for release. This is where the final level of testing, last minute fixes, and Version Tagging can happen (v. Once all of this has cleared, the Release can be merged into the Main Branch.

#### Hotfix Management

Any last minute fixes that are discovered in the development phase 
