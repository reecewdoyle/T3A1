...
A JSON ( JavaScript Object Notation) looks very similar to an object. The primary difference is that a JSON is mostly used for data-interchange in API's and for configuration settings. A object is used 
***
### References
