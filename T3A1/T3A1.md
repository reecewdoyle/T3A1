...
Non-Destructive methods of manipulating arrays allow you to make copies of the original array that can be changed while still keeping the original array intact, and therefore maintaining in the integrity of the original . 
