...
4. APIs (Application Programming Interfaces): Back End Devs must be able to build and use APIs, which are used as a means of communicating between different systems. e.g. Connecting a PostgrSQL database to a website, and allowing the user the ability to Create, 
