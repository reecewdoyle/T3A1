...
"mod" is the parameter being passed by the constructor. This will store the value generated when the `
*/
	} 
	show() { 
...
The `Model` constructor which contains `super(brand)` calls the parent constructor of `Car`, which generates `make` as the `brand`. This then sets the `carname` property of the instance. 
