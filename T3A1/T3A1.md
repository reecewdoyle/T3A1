...
* **Intuitive:** This would be related to the steepness of the learning curve for the end user. If it's too difficult to learn, people won't use it. e.g. if it's a personal finance app, but the interface has too many submenus peop
...
* **Performance:** This is to do with the speed and responsiveness of the software. It must be quick to perform tasks and move between screens.
...
* **Modularity:** A modular piece of software would be made of seperate parts that can be independently modified, fixed and upgraded. 
