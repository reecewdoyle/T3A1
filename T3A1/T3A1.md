...
`BigInt` is used to represent whole numbers that are larger than 2^53 -1. this is the highest number that JavaScript can reliable represent within the `Number` data type. 
```javascript
