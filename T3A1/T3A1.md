...
let fightingPokemon; 
// This is a variable that needs to be declared outside of the loop. This is where we will send the pokem

do {
    fightingPokemon = eliteFourBattleTeam.shift(); 
// Shift the first pokemon from the array
...
// Continue the loop as long as there are Pokémon left in the array
