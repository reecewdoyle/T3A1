...
![mern-dev](mern-dev.png)

![mern](mern.png)

**React** is a JavaScript library used to build the User Interface (UI). The application communicates with a **Node.js API** using HTTP requests in JSON format. The API accesses a **MongoDB** database to return the results of the queries that the user entered.
