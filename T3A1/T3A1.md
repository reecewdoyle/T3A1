...
The Macro skill I had to learn above this was also `Try` and `Except` blocks and error handling. Without this, the app would throw errors when it didn't find the `results`
***
### References
