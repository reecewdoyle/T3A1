...
Once a developer has completed their work, the Team Leader must first review the code before it is merged into the codebase. Once the work is approved, it can be merged from a feature branch onto the development branch.
