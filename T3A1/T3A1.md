...
To do this, I simply copied the code, commented out what I didn't need, and declared `week_num = week_num_to_test`. I then declared `week_num_to_test = 10`. This meant the function stayed as intact as humanly possible. As 10 is outside of the range of 6 and 43, it printed `No Games this week`. Considering this project was delivered in late December 2023, the only way to prove the 
