...
*/
	...
	const fightingPokemon = eliteFourBattleTeam.pop(); 
// This is a variable that is created to hold the value of the pokemon from the array that gets `popped` by the `eliteFourBattleTeam.pop()` method.
