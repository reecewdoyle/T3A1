...
This is not quite the same as Type Conversion, as that is a change that happens either explicitly or implicitly. Type Coercion only happens implicitly, meaning that JavaScript automatically determine from the context
***
### References
